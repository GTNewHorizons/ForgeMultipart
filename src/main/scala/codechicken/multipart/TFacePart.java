 ...
 * <p>
 * TMultiPart declares neither member, so unlike the other converted traits these can safely be default methods.
 */
public interface TFacePart extends TSlottedPart {
    ...
    /**
     * Return the redstone conduction map for which signal can pass through this part on the face. Eg, hollow covers
     * return 0x10 as signal can pass through the center hole.
     */
